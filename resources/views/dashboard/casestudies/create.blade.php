    ...
    <div class="p-6 ">
        <div class="p-6 bg-white rounded-md">
            <div class="flex justify-between items-center mb-4">
                ...
                <h1 class="font-raleway font-bold uppercase text-eve">Case Study Information</h1>
            ...
            <form method="POST" action="{{ route('casestudies.store') }}" class="w-full grid grid-cols-1 sm:grid-cols-3 gap-5" enctype="multipart/form-data">
                @csrf

                <!-- Number -->
                <div>
                    <x-input-label for="number" :value="__('Case Number')" />
