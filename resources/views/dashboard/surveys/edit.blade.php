            ...
            <form method="POST" action="{{ route('surveys.update', $survey->id) }}"
                ...
                <div>
                    ...
                    <x-text-input id="number" class="block mt-1 w-full" type="text" name="number"
                        value="{{ $survey->number }}" required autofocus />
                ...
                <div class="">
                    ...
                    <x-text-input type="text" class="block mt-1 w-full" id="supervisors" name="supervisors"
                        value="{{ $survey->supervisor }}" />
                    <p class="mt-1 text-sm text-adam font-raleway" id="file_input_help">Supervisors name should be
                ...
                <div class="">
                    ...
                    <x-text-input type="text" class="block mt-1 w-full" id="link" name="link"
                        value="{{ $survey->link }}" />
                ...
                <div class="">
                    ...
                    <x-text-input type="file"
                        class="block mt-1 w-full file:mr-5 file:py-3 file:px-4 file:border-0 file:font-raleway  file:text-white file:bg-eve text-eve"
                        id="file" name="file" />
                    <p class="mt-1 text-sm text-adam font-raleway" id="file_input_help">DOC,PDF, XLS, JPG (MAX. 5MB).
                    </p>
