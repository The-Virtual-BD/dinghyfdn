                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="flex items-center text-sm font-medium text-adam hover:text-dark hover:border-gray-300 focus:outline-none focus:text-adam focus:border-gray-300 transition duration-150 ease-in-out">
                            <div class="uppercase bg-eve w-10 h-10 rounded-full flex justify-center items-center text-white font-bold mr-1">{{Auth::user()->name[0].Auth::user()->name[1]}}</div>
                            <div class="text-eve">{{ Auth::user()->name }}</div>
