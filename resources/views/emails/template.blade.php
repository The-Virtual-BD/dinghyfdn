        ...
        <table width="100%" cellpadding="0" cellspacing="0" bgcolor="FFFFFF"
            ...
            <tr>
                <td style="padding: 20px; text-align: center;" class="bg-eve">
                    <h1 style="color: #ffffff" class="text-white font-raleway uppercase font-bold">Thanks for donation
                    </h1>
                </td>
            </tr>
            <tr class="" style="background-color: #ffffff;">
                <td class="p-5">
                    ...
                    <p class="font-raleway leading-6">
                        Dear User, <br />
                        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quaerat amet, aliquid ipsum qui
                        expedita ad corrupti culpa numquam explicabo soluta consectetur cumque harum voluptatibus neque?
                        Minus, praesentium sunt fugit provident mollitia unde eos aliquam eaque, soluta, voluptates quae
                        doloribus. Necessitatibus, quia. Incidunt impedit delectus fugit possimus aperiam cum, nisi
                        corporis?
                    </p>
                    ...
                    <center class="my-12">
                        <a href="http://www.dinghyfdn.org" style="color: #fff; text-decoration: none;" target="_blank">
                            <button
                                class="inline-flex items-center p-1 sm:px-5 sm:py-4 bg-eve font-bold text-sm text-white font-raleway uppercase tracking-widest hover:bg-white border border-eve hover:border hover:border-eve hover:text-eve  justify-center"
                                type="submit">
                                Visit Site
                            </button>
                        </a>
